...
button_CLR=Button(window,text='CLR' ,font=bfont,borderwidth=w1 ,padx=45,pady=y,bg='#666699',command=lambda: button_click('c')).grid(row=3 ,column=0)
button_MOD=Button(window,text='%' ,font=bfont,borderwidth=w1,padx=45,pady=y,bg='#666699',command=lambda: button_click('%')).grid(row= 3,column=1)
button_ON=Button(window,text='DEL' ,font=bfont,borderwidth=w1,padx=45,pady=y,bg='#666699',command=lambda: button_click('del')).grid(row= 3,column=2)
button_OFF=Button(window,text='ON/OFF' ,font=bfont,borderwidth=w1,padx=35,pady=y,bg='#666699',fg='#ffffff',command=lambda: button_click('o')).grid(row=3 ,column=3)
